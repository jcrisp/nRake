...
h2. How to use
* Choose your version:
  ** "nRake with Iron Ruby for .NET 4":https://github.com/jcrisp/nRake/tree/IronRuby4 (recommended for .NET 4)
  ** "nRake with Iron Ruby for .NET 2/3.5":https://github.com/jcrisp/nRake/tree/IronRuby2 (recommended if you're not on .NET 4)
  ** "nRake with bundled Ruby 1.9":https://github.com/jcrisp/nRake (legacy)
