...
h2. How to use
* Choose your version:
  * "nRake with Iron Ruby for .NET 4":https://github.com/jcrisp/nRake/tree/IronRuby4 (recommended)
  * "nRake with Iron Ruby for .NET 2/3.5":https://github.com/jcrisp/nRake/tree/IronRuby2
  * "nRake with bundled Ruby 1.9 (legacy)":https://github.com/jcrisp/nRake
